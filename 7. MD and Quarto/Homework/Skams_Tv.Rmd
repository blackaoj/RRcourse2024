...
This article is about my favorite Norway Tv-serious---- Skams, or shames whatever[wikipedia](https://en.wikipedia.org/wiki/Skam_(TV_series))
# Short description
...
```{r fig1, echo = FALSE, out.width = "60%", out.height = "25%", fig.cap = "Skam title", fig.show = "hold", fig.align = "center"}
